...
本文档详细说明每个文件夹应在哪个开发环境中操作，帮助你高效进行毕业设计开发。
...
### 第三阶段：大数据处理（第5-6周）【IntelliJ + PyCharm】
...
### 第四阶段：后端服务（第9-10周）【IntelliJ IDEA】
...
- [ ] `main`分支代码可正常运行
- [ ] 打tag: `git tag -a v1.0.0 -m "毕业答辩版本"`
- [ ] Docker环境一键启动
- [ ] 前后端联调成功
- [ ] AI对话功能可用
- [ ] 缠论分析结果正确
